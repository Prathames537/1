    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-16">
        <div className="container mx-auto px-6">
          ...
          <ChatBotDialog open={open} onOpenChange={setOpen} botType="assistant" />
          ...
          <ChatBotDialog open={doctorOpen} onOpenChange={setDoctorOpen} botType="doctor" />
          <ChatBotDialog open={patientOpen} onOpenChange={setPatientOpen} botType="patient" />
        </div>
      </main>
      <Footer />
    </div>
