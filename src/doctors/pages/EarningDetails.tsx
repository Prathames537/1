...
const EarningDetails = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <Button variant="ghost" size="icon" onClick={() => navigate('/doctors/earnings')}>
        Back to Earnings
      </Button>
      ...
      <div className="bg-white rounded-xl shadow-card p-6">
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-welli-textSecondary">{earning.consultationType} • {earning.date}</p>
            <p className="text-welli-textSecondary">Amount: ₹{earning.amount.toLocaleString()}</p>
